                    ...
                    <div class="col-12 col-sm-7 col-md-8 col-lg-6">
                        ...
                        <div class="d-none d-sm-block d-lg-none mt-2 mb-n2">
                            ...
                            <div>
                                ...
                                {{ empty($channel['region']) ? 'Россия' : $channel['region'] }},
                                {{ empty($channel['language']) ? 'Русский' : $channel['language'] }}
                            </div>
                            <div>
                                <b>Категория:</b>
                                <a href="/categ/{{ $channel['category'] }}"> {!! Data::friendly_name($channel['category']) !!} </a>
                            </div>
                        </div>
